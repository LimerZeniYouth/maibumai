        ...
        children: [
            ...
            children: [
              for (final filter in StatsFilter.values)
                ChoiceChip(
                  ...
                  onSelected: (_) =>
                      context.read<AppProvider>().updateStatsFilter(filter),
                ),
            ],
          ),
          const SizedBox(height: 16),
          LayoutBuilder(
            builder: (context, constraints) {
              final ratio = constraints.maxWidth < 360 ? 1.32 : 1.58;
          ...
          if (stats.categoryBreakdown.isEmpty)
            ...
            _ChartSection(
              ...
              child: MonthlyBarChart(
                ...
                maxY: repository
                    .niceMax(stats.monthlySavings.map((item) => item.amount)),
              ),
            ),
            const SizedBox(height: 14),
            _ChartSection(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF223767).withValues(alpha: 0.24),
            blurRadius: 24,
